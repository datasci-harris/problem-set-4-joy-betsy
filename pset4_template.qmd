...
texas_closures = valid_sorted_closed[
    valid_sorted_closed['ZIP_CD'].astype(str).str.startswi(texas_prefixes)
]
...
buffer_distance_meters = 10 / 0.000621371

directly_affected_centroids = zips_texas_centroids[
    zips_texas_centroids['ZCTA5'].isin(texas_closures_by_zip['ZIP_CD'])
]
directly_affected_centroids['buffer'] = directly_affected_centroids.geometry.buffer(buffer_distance_meters)

indirectly_affected = gpd.sjoin(
    zips_texas_centroids,
    directly_affected_centroids.set_geometry('buffer'),
    how='inner',
...
print("Columns in indirectly_affected:", indirectly_affected.columns)
